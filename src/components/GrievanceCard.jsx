  ...
  return (
    <>
      <motion.div
        ...
        className={`group/card glass-panel-strong hover-lift relative cursor-pointer overflow-visible p-5 pb-6 ${borderClass}`}
            ...
            >
              ...
              {grievance.resolutionPhoto?.url && (
                <div className="mt-4 overflow-hidden rounded-xl border border-emerald-100 bg-white">
                  <img
                    src={grievance.resolutionPhoto.url}
                    alt="Solved proof"
